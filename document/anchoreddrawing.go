...
import (
	...
	pic "github.com/t-xl/gooxml/schema/soo/dml/picture"
...
func (a AnchoredDrawing) SetSize(w, h measurement.Distance) {
	a.x.Extent.CxAttr = int64(float64(w*measurement.NOFFZZ) / measurement.Ppi)
	a.x.Extent.CyAttr = int64(float64(h*measurement.NOFFZZ) / measurement.Ppi)
}
